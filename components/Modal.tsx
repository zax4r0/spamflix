          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block w-full max-w-md p-5 my-8 overflow-hidden  align-middle transition-all transform bg-white">
                ...
                <Dialog.Title as="h3" className="font-bold  text-2xl leading-6 text-gray-900 text-left mb-10 mt-14 ">
                  LOG IN
                </Dialog.Title>

                <div className="flex flex-col mb-48 mt-18">
                  <div className="mb-4">
                    <label className="block text-[#9AA1B0]  text-sm font-bold mb-3 text-left" htmlFor="username">
                      USERNAME
                    </label>
                    <input
                  ...
                  <div className="mb-6">
                    <label className="block text-[#9AA1B0] text-sm font-bold mb-3 text-left" htmlFor="password">
                      Password
                    </label>
                    <input
