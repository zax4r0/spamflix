...
import profileimage from '/public/icon/android-chrome-192x192.png'
      ...
      <div className="relative flex flex-col min-w-0 break-words bg-black  w-full mb-6 shadow-xl rounded-lg mt-16">
        <div className="px-6">
          ...
          <div className="text-center mt-12">
            <h3 className="text-xl font-semibold leading-normal mb-2 text-blueGray-700">Jenna Stones</h3>
