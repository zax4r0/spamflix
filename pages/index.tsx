      ...
      <BaseLayout title="" path="/" description="Stream Movies and Shows For free" Icon={HomeIcon}>
        <header className="header h-530 bg-header-img bg-cover bg-no-repeat bg-center">
          ...
          <div className="flex flex-col justify-start items-center mt-10 text-white space-y-6">
            <h4 className="uppercase text-sm text-hulu-green font-bold mb-5">BUNDLE WITH ANY HULU PLAN AND SAVE</h4>
            ...
            <button
              onClick={() => router.push('/home?genre=fetchTrending')}
        ...
        <section className=" bg-black  opacity-100 grid grid-cols-1 md:grid-cols-3 gap-8 items-center px-8 py-6  text-white">
          <Image src={hulusmall} alt="" />
          <div className="space-y-3 text-center md:text-left">
            <h4 className="uppercase text-sm text-hulu-green font-bold text-center">TRY UP TO ONE MONTH FREE</h4>
        ...
        <section className="flex flex-col text-center justify-items-center items-center px-16 py-20 text-white bg-black">
          <h4 className="uppercase text-sm text-hulu-green font-bold">Included in all plans</h4>
          <div className="font-bold text-5xl md:text-7xl mt-6">All The TV You Love</div>
        ...
        <section className="px-10  bg-live-section text-white">
          <div className="flex flex-col items-center justify-center text-center  px-10 md:p-28 space-y-7">
            <h4 className="uppercase text-sm text-hulu-green font-bold">Hulu + Live TV</h4>
            <div className="font-bold text-4xl md:text-7xl">Live TV Makes It Better</div>
            <div className="text-xl md:text-2xl max-w-3xl font-thin">
              Make the switch from cable. Get 75+ top channels with your favorite live sports, news, and events - plus
              the entire Hulu streaming library.
            </div>
            <div className="text-gray-300 text-xl">Regional restrictions, blackouts and additional terms apply.</div>

            <a onClick={() => router.push('/home')} className="uppercase underline cursor-pointer">
        ...
        <section className="h-screen relative bg-livesport-small md:bg-livesport-img bg-cover bg-no-repeat bg-center text-white">
          <div className="absolute max-w-550 top-28 left-6 md:top-160 md:left-100 space-y-7">
            ...
            <div className="text-2xl max-w-2xl">
              Catch your games at home or on the go. Stream live games from major college and pro leagues including the
